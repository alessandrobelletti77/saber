...
class TranslationsHomeEn {
	...
	/// en: 'Welcome to DODO NOTES'
	String get welcome => 'Welcome to DODO NOTES';
...
class TranslationsSettingsEn {
	...
	/// en: 'Open DODO NOTES folder'
	String get openDataDir => 'Open DODO NOTES folder';
...
class TranslationsSentryConsentEn {
	...
	/// en: 'Help improve DODO NOTES?'
	String get title => 'Help improve DODO NOTES?';
...
class TranslationsSettingsPrefLabelsEn {
	...
	/// en: 'Check for DODO NOTES updates'
	String get shouldCheckForUpdates => 'Check for DODO NOTES updates';
	...
	/// en: 'Custom DODO NOTES folder'
	String get customDataDir => 'Custom DODO NOTES folder';
...
class TranslationsSettingsPrefDescriptionsEn {
	...
	/// en: '(Not recommended) Allow DODO NOTES to connect to servers with self-signed/untrusted certificates'
	String get allowInsecureConnections => '(Not recommended) Allow DODO NOTES to connect to servers with self-signed/untrusted certificates';
...
class TranslationsLoginNcLoginStepEn {
	...
	/// en: 'DODO NOTES's Nextcloud server'
	String get saberNcServer => 'DODO NOTES\'s Nextcloud server';
	...
	/// en: 'Login with DODO NOTES'
	String get loginWithSaber => 'Login with DODO NOTES';
...
class TranslationsLoginEncLoginStepEn {
	...
	/// en: 'New to DODO NOTES? Just enter a new encryption password.'
	String get newToSaber => 'New to DODO NOTES? Just enter a new encryption password.';
...
class TranslationsProfile$faq$0i1$En {
	...
	/// en: 'Go to your server website and log in. Then go to Settings > Security > Change password. You'll need to log out and log back in to DODO NOTES after changing your password.'
	String get a => 'Go to your server website and log in. Then go to Settings > Security > Change password. You\'ll need to log out and log back in to DODO NOTES after changing your password.';
}
...
class TranslationsProfile$faq$0i2$En {
	...
	/// en: '0. Make sure syncing is complete (see the sync progress on the home screen). 1. Log out of DODO NOTES. 2. Go to your server website and delete your 'DODO NOTES' folder. This will delete all your notes from the server. 3. Log back in to DODO NOTES. You can choose a new encryption password when logging in. 4. Don't forget to log out and log back in to DODO NOTES on your other devices too.'
	String get a => '0. Make sure syncing is complete (see the sync progress on the home screen).\n1. Log out of DODO NOTES.\n2. Go to your server website and delete your \'DODO NOTES\' folder. This will delete all your notes from the server.\n3. Log back in to DODO NOTES. You can choose a new encryption password when logging in.\n4. Don\'t forget to log out and log back in to DODO NOTES on your other devices too.';
}
...
class TranslationsProfile$faq$0i3$En {
	...
	/// en: 'Tap on the "Delete account" button above, and login if needed. If you are using the official DODO NOTES server, your account will be deleted after a 1 week grace period. You can contact me at adilhanney@disroot.org during this period to cancel the deletion. If you are using a third party server, there might not be an option to delete your account: you'll need to consult the server's privacy policy for more information.'
	String get a => 'Tap on the "${_root.profile.quickLinks.deleteAccount}" button above, and login if needed.\nIf you are using the official DODO NOTES server, your account will be deleted after a 1 week grace period. You can contact me at adilhanney@disroot.org during this period to cancel the deletion.\nIf you are using a third party server, there might not be an option to delete your account: you\'ll need to consult the server\'s privacy policy for more information.';
}
...
class TranslationsEditorVersionTooNewEn {
	...
	/// en: 'This note was edited using a newer version of DODO NOTES'
	String get title => 'This note was edited using a newer version of DODO NOTES';
...
class TranslationsLoginNcLoginStepLoginFlowEn {
	...
	/// en: 'Please authorize DODO NOTES to access your Nextcloud account'
	String get pleaseAuthorize => 'Please authorize DODO NOTES to access your Nextcloud account';
...
class TranslationsLoginEncLoginStep$encFaq$0i1$En {
	...
	/// en: 'Choose a new encryption password and enter it above. DODO NOTES will generate your encryption keys from this password automatically.'
	String get a => 'Choose a new encryption password and enter it above.\nDODO NOTES will generate your encryption keys from this password automatically.';
}
